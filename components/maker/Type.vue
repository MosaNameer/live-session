<template>
    <div flex="~ gap-6" text="whitesec">
        <div v-for="_type in types" :key="_type">
            <input :id="_type" v-model="store.selectedSlide.type" :value="_type" class="hidden" type="radio">
            <label :for="_type" py="12px" px="6px" text-center w-full block cursor-pointer my-2 border="1px secondary" :bg="store.getSelectedSlide?.type == _type">
